...
import { Container, AppBar, Toolbar, Typography, Button, Box, Card, CardContent, TextField, Alert, IconButton, Menu, MenuItem } from '@mui/material'
...
function App() {
  ...
  const HomePage = () => (
    <Box>
      ...
      <Box
        sx={{
          backgroundImage: 'linear-gradient(rgba(139, 21, 56, 0.8), rgba(197, 60, 60, 0.8)), url("/images/e3fc3a8c-e076-4ec8-b176-cbb5d18d460d.jpg")',
      ...
      <Container maxWidth="lg" sx={{ py: 8 }}>
        ...
        <Box sx={{
          ...
          <Card sx={{ height: '100%', textAlign: 'center', p: 2 }}>
            <Box
              component="img"
              src="/images/4acd3e8e-2b0d-4114-9f68-0a7361227903.jpg"
